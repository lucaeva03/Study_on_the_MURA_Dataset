...
svm_model = SVC(kernel='linear', C=10000, gamma='scale') 
...
svm_model_pca = SVC(kernel='linear', C=10000, gamma='scale')
...
if hasattr(svm_model, "decision_function"):
    y_prob = svm_model.decision_function(X_valid)
else:
    y_prob = svm_model.predict_proba(X_valid)[:, 1]

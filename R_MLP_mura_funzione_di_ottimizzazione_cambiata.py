...
# Creazione e configurazione della rete MLP con ottimizzatore SGD
mlp = MLPClassifier(hidden_layer_sizes=(128, 64), activation='relu', solver='sgd', learning_rate='constant', learning_rate_init=0.01, max_iter=50, random_state=42)
